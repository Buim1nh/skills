...
| **instance segmentation** | ❌ phân đoạn đối tượng cắt rời | "phân đoạn cá thể (instance segmentation)" ở lần đầu, sau đó dùng "phân đoạn cá thể" |
...
| **polygon** | ❌ hình đa giác uốn lượn | "đa giác (polygon)" ở lần đầu, sau đó dùng "polygon" hoặc "đa giác" |
...
| **file ZIP** | ❌ tệp nén ZIP, gói nén | "file ZIP" |
...
| **bằng chứng** (evidence trong bài lab) | **kết quả bài làm / số liệu dẫn chứng** | Sinh viên làm bài tập, không phải điều tra án |
